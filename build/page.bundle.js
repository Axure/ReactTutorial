...
/***/ function(module, exports, __webpack_require__) {
	...
	var listData = [{ entry: "Name", content: "Yulu Chen" }, { entry: "Age", content: "19" }, { entry: "Gender", content: "Female" }, { entry: "Email", content: "lulucici77@gmail.com" }, { entry: "Intro", content: "A girl" }];
	...
	var cardsData = [cardData, cardData, cardData, cardData];
	//
	//React.render(
	//    <List entries={listData}/>
	//    , document.body);
	React.render(React.createElement(Card, { data: cardData }), document.body);
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: 'col-left' },
	                React.createElement(List, { entries: this.props.data.textData })
	            ),
	            React.createElement(
	                'div',
	                { className: 'col-right' },
	                React.createElement('img', { src: this.props.data.imgSrc })
	            )
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var ListEntry = __webpack_require__(160);
	...
	var List = React.createClass({
	    ...
	    render: function render() {
	        ...
	        for (var i = 0; i < rawEntries.length; ++i) {
	            entries.push(React.createElement(ListEntry, { entry: rawEntries[i].entry, content: rawEntries[i].content }));
	        }
	        return React.createElement(
	            'ul',
	            null,
