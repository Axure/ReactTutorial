...
/***/ function(module, exports, __webpack_require__) {
	...
	var TopNavApp = __webpack_require__(161);
	var React = __webpack_require__(2);

	React.render(React.createElement(TopNavApp, null), document.body);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TopNavJsx = __webpack_require__(162);

	var _TopNavJsx2 = _interopRequireDefault(_TopNavJsx);
	...
	var StateContainer = (function (_React$Component) {
	    ...
	    function StateContainer() {
	        ...
	        _get(Object.getPrototypeOf(StateContainer.prototype), 'constructor', this).call(this);
	    ...
	    _createClass(StateContainer, [{
	        key: 'changeState',
	        value: function changeState(key, value) {
	            console.log(this);
	        ...
	        value: function render() {
	            return React.createElement(_TopNavJsx2['default'], _extends({}, this.state, { changeStore: this.changeState, root: this }));
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PrimaryNavJsx = __webpack_require__(163);

	var _PrimaryNavJsx2 = _interopRequireDefault(_PrimaryNavJsx);
	...
	var TopNav = (function (_React$Component) {
	    ...
	    function TopNav() {
	        ...
	        _get(Object.getPrototypeOf(TopNav.prototype), 'constructor', this).call(this);
	    }
	    ...
	    _createClass(TopNav, [{
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                null,
	                'hi',
	                React.createElement('button', { onClick: this.props.changeStore.bind(this.props.root, 'hah', 'heh') }),
	                React.createElement(_PrimaryNavJsx2['default'], { primaryNavList: this.props.items })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PrimaryNav = (function (_React$Component) {
	    ...
	    function PrimaryNav() {
	        ...
	        _get(Object.getPrototypeOf(PrimaryNav.prototype), 'constructor', this).call(this);
	    }

	    _createClass(PrimaryNav, [{
	        key: 'render',
	        value: function render() {
	            var items = this.props.primaryNavList.map(function (item) {
	                return React.createElement(PrimaryNavItem, { item: item });
	            });
	...
	var PrimaryNavItem = (function (_React$Component2) {
	    _inherits(PrimaryNavItem, _React$Component2);

	    function PrimaryNavItem() {
	        _classCallCheck(this, PrimaryNavItem);

	        _get(Object.getPrototypeOf(PrimaryNavItem.prototype), 'constructor', this).call(this);
	    }

	    _createClass(PrimaryNavItem, [{
	        key: 'render',
	        value: function render() {
	            return React.createElement(
	                'li',
